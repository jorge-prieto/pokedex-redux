      ...
      <div className="home-container flex justify-center items-center">
        <div className="text-container">
          ...
          <Link to="pokemons">
            <button
              type="button"
              className="button w-3/4 md:w-3/4 h-10 bg-orange rounded-lg border-solid font-bold hover:bg-yellow hover:text-red cursor-pointer"
            >
              VIEW ALL POKEMONS
            </button>
          </Link>
